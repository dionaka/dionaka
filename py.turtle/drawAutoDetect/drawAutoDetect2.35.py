...
while True:
    ...
    # REMOVE START: Lines that were causing unconditional image loading
    # img_color = cv2.imread('your.png', 1)
    # img_pillow = None
    # img_width = 0
    # img_height = 0
    ...
    #         print("Pillow 读取图片成功。") # This line should no longer appear unconditionally
    ...
    #         import traceback
    #         traceback.print_exc()
    # REMOVE END: Unconditional image loading
